      ...
      <div className="container footer-grid">
        ...
        <div className="footer-column">
          ...
          <div className="footer-hours-item">
            <span className="footer-hours-label">Monday - Saturday</span>
            <span className="footer-hours-value">9:00 AM - 5:00 PM</span>
          </div>
          <div className="footer-hours-item">
            <span className="footer-hours-label">Sunday School Classes</span>
            <span className="footer-hours-value">9:00 AM - 10:30 AM</span>
          </div>
          <div className="footer-hours-item">
            <span className="footer-hours-label">Sunday Holy Mass</span>
            <span className="footer-hours-value">7:00 AM, 10:45 AM, 5:30 PM</span>
          </div>
        </div>
      </div>
